...
export default function NotificationsPage() {
  ...
  // useCallback — stable reference for mark read
  ...
  // useCallback — stable reference for mark all read
  ...
  // useMemo — only recompute filtered list when notifications or filter changes
